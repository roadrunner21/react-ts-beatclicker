...
function About() {
    return (
        <Container>
            <Typography variant="h4" component={"h1"}>About Beat Clicker</Typography>
            <Divider/>
            <Typography variant={"body1"}>
                Beat Clicker is a rhythm game where players have to tap in time with the beat.
            </Typography>
            <Typography variant="h5">Score Algorithm</Typography>
            <Divider/>
            ...
            <Divider/>
            <Typography>
                You can find more information about me and my work on my <Link target="_blank"
                                                                               href="https://linkedin.com/in/themarcohefti/">LinkedIn</Link> or
                my <Link
                target="_blank"
